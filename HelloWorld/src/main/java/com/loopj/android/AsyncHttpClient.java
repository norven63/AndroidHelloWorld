 ...
 * DELETE HTTP requests in
 * your Android applications. Requests can be made with additional parameters by
 * passing a {@link RequestParams} instance, and responses can be handled by
 * passing an anonymously overridden {@link ResponseHandlerInterface} instance.
 * <p>
 * &nbsp;
 * </p>
 * For example:
...
public class AsyncHttpClient {
	 ...
	 * settings for requests by accessing the client's ConnectionManager,
	 * HttpParams and
	 * SchemeRegistry.
	 * 
	 ...
	 * settings for requests by accessing the context's attributes such as the
	 * CookieStore.
	 * 
	...
	/**
	 * Sets the SSLSocketFactory to user when making requests. By default, a new,
	 * default
	...
	/**
	 * Sets basic authentication for the request. Uses AuthScope.ANY. This is the
	 * same as
	 ...
	 * non-null
	 * android Context. This method is intended to be used in the onDestroy method
	 * of your android
	...
	public RequestHandle head(Context context, String url, RequestParams params, ResponseHandlerInterface responseHandler) {
		return sendRequest(httpClient, httpContext, new HttpHead(getUrlWithQueryString(isUrlEncodingEnabled, url, params)), null,
	 ...
	 *          the URL to send the request to.
	 * @param entity
	 *          a raw {@link org.apache.http.HttpEntity} to send with the request,
	 *          for
	 ...
	 *          set headers only for this request
	 * @param entity
	 *          a raw {@link HttpEntity} to send with the request, for example,
	 *          use
	 *          this to send string/json/xml payloads to a server by passing a
	...
	/**
	 * Sets state of URL encoding feature, see bug #227, this method allows you to
	 * turn off and on
	...
	/**
	 * Returns HttpEntity containing data from RequestParams included with request
	 * declaration.
	 ...
	 * HttpEntityEnclosingRequestBase, which is for
	 * example not DELETE
	 * 
	 * @param entity
