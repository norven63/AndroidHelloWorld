...
public class AsyncHttpClient {
   ...
   * &nbsp;
   * </p>
   * <b>Note:</b> This will only affect requests which were created with a non-null android Context.
   * This method is intended to be used in the onDestroy method of your android activities to
  ...
  /**
   * Perform a HTTP GET request without any parameters and track the Android Context which initiated
   * the request.
   * 
   * @param context the Android Context which initiated the request.
   * @param url the URL to send the request to.
   ...
   * @param context the Android Context which initiated the request.
   * @param url the URL to send the request to.
   * @param entity a raw {@link org.apache.http.HttpEntity} to send with the request, for example,
   *          use this to send string/json/xml payloads to a server by passing a
   *          {@link org.apache.http.entity.StringEntity}.
   * @param contentType the content type of the payload you are sending, for example
   *          application/json if sending a json payload.
  ...
  /**
   * Sets the User-Agent header to be sent with each request. By default, "Android Asynchronous Http
   * Client/VERSION (http://loopj.com/android-async-http/)" is used.
   * 
   ...
   * @param uriRequest instance of HttpUriRequest, which means it must be of HttpDelete, HttpPost,
   *          HttpGet, HttpPut, etc.
   * @return RequestHandle of future request process
   */
  ...
  /**
   * Returns HttpEntity containing data from RequestParams included with request declaration. Allows
   * also passing progress from upload via provided ResponseHandler
   * 
